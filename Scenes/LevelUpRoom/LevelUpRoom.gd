...
func _ready()->void:
	...
	$Tasks.button_up.connect(get_tree().change_scene_to_file.bind("res://Scenes/TasksRoom/Building_room.tscn"))
	$Building.button_up.connect(get_tree().change_scene_to_file.bind("res://Scenes/TasksRoom/Tasks_room.tscn"))
